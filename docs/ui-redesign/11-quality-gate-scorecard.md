...
| **Responsive** | designer + qa-tester | 1280 + 820 usable (P0 floor); 390px + chart/list toggle is P1; sub-390px non-goal | 🔴 | — | Screenshot evidence at 1280 + 820 |
...
`docs/ui-redesign/verification.md` (template ships with this doc set; evidence is recorded during each milestone, finalized in M6) records, per gate: commands run, outputs/SHA of key files, screenshots/Walkthrough artifacts, and known limitations.